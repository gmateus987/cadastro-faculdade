        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard.search')" :active="request()->routeIs('dashboard.search', 'search.show', 'search.edit', 'search.image', 'search.delete')">
                        {{ __('Pesquisar Notas') }}
                    </x-nav-link>

                    <x-nav-link :href="route('users.index')" :active="request()->routeIs('users.index', 'user-edit', 'users.update')">
                        {{ __('Editar Usuários') }}
                    </x-nav-link>
